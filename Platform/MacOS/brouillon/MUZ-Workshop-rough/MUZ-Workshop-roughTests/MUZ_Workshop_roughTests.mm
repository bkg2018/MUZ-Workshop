//
//  MUZ_Workshop_roughTests.m
//  MUZ-Workshop-roughTests
//
...
@interface MUZ_Workshop_roughTests : XCTestCase

@end

@implementation MUZ_Workshop_roughTests

const std::string SourcesRootDir = "/Users/bkg2018/Desktop/RETROCOMP/RC2014/MUZ-Workshop/MUZ-GIT/MUZ/TestSources/";
std::string RomHexFilePath ;


- (void)setUp {
    RomHexFilePath = SourcesRootDir + "IntelHex.hex";
}
